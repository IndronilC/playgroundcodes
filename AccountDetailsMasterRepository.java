...
import com.rabobank.account.transaction.validation.accounttransactionvalidator.entity.AccountDetailsMasterEnttity;
 ...
 *         <P>
 *         <H1>This interface AccountDetailsMasterEnttity on whom it will be perform the
 ...
 *         is accountId -> as the other parameter</H1>
 */
public interface AccountDetailsMasterRepository extends JpaRepository<AccountDetailsMasterEnttity, Long> {
